...
import startPointVertex from "../../shader/firework/start/vertex.glsl";
import startPointFragment from "../../shader/firework/start/fragment.glsl";
import fireworksVertex from "../../shader/firework/end/vertex.glsl";
import fireworksFragment from "../../shader/firework/end/fragment.glsl";
...
export default class Fireworks {
	constructor(color, to, from = { x: 0, y: 0, z: 0 }) {
		...
		const positionFireworksArray = new Float32Array(
			this.FireworksCount * 3
		);
